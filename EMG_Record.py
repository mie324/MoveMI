...
`'''
    ...
    try:
        ...
        while True:
            ...
            if currValues != [0, 0, 0, 0, 0, 0, 0, 0, 0]:
                ...
                if numpyArray.all() == None:
                    numpyArray = np.asarray(currValues)
                else:
                    numpyArray = np.vstack((numpyArray, np.asarray(currValues)))
        ...
        np.savetxt("./data/data_" + str(label) + "_" + participant + ".csv", numpyArray, delimiter=",")
        print("Completed")
